...
wget --no-check-certificate 'https://docs.google.com/uc?export=download&id=0B5R2YTHDeD6sVVQ1UlJEYWxGZWc' -O chemicals.txt
wget --no-check-certificate 'https://docs.google.com/uc?export=download&id=0B5R2YTHDeD6scnRXVGllRno3QUU' -O diseases.txt
wget --no-check-certificate 'https://docs.google.com/uc?export=download&id=0B5R2YTHDeD6sUzVydDNScXQ1MzA' -O genes.txt
wget --no-check-certificate 'https://docs.google.com/uc?export=download&id=0B5R2YTHDeD6sVVh0a3E5WndXbHM' -O proteins.txt
